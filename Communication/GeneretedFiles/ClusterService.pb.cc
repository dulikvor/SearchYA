...
void protobuf_AddDesc_ClusterService_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "(\010H\000\022\025\n\013valueString\030\006 \001(\tH\000\022\035\n\025valueStri"
    "ngCollection\030\007 \003(\t\022-\n\004type\030\010 \001(\0162\037.Clust"
    "erService.Param.ValueType\022\014\n\004name\030\t \001(\t\""
    "0\n\tValueType\022\r\n\tPrimitive\020\000\022\024\n\020StringCol"
    "lection\020\001B\014\n\nvalueOneOf\"6\n\006Params\022,\n\rgen"
    "ericParams\030\002 \003(\0132\025.ClusterService.Param2"
    "\276\001\n\010Commands\0227\n\004Init\022\026.ClusterService.Pa"
    "rams\032\025.ClusterService.Empty\"\000\022<\n\nSubmitT"
    "ask\022\025.ClusterService.Empty\032\025.ClusterServ"
    "ice.Empty\"\000\022;\n\tTerminate\022\025.ClusterServic"
    "e.Empty\032\025.ClusterService.Empty\"\000b\006proto3", 600);
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 6: {
        ...
        if (input->ExpectTag(58)) goto parse_valueStringCollection;
        break;
      }
      ...
      // optional .ClusterService.Param.ValueType type = 8;
      case 8: {
        if (tag == 64) {
         parse_type:
          int value;
...
void Param::SerializeWithCachedSizes(
  ...
  for (int i = 0; i < this->valuestringcollection_size(); i++) {
    ...
    ::google::protobuf::internal::WireFormatLite::WriteString(
      7, this->valuestringcollection(i), output);
  }
...
::google::protobuf::uint8* Param::InternalSerializeWithCachedSizesToArray(
  ...
  for (int i = 0; i < this->valuestringcollection_size(); i++) {
    ...
    target = ::google::protobuf::internal::WireFormatLite::
      WriteStringToArray(7, this->valuestringcollection(i), target);
  }
